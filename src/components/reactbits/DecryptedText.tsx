/*
 * DecryptedText — vendored from React Bits (reactbits.dev), TS + CSS variant.
 *
 * Copied as source rather than installed, which is how React Bits ships. One
 * change from upstream, marked VENDORED, PATCHED below. Keep it when updating.
 */
...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    // VENDORED, PATCHED: upstream constructs the observer unconditionally, which
    // throws wherever there is not one — jsdom under the test suite, and any
    // browser old enough to lack it. Without an observer the text is simply
    // already decrypted, which is the state this animation ends in anyway.
